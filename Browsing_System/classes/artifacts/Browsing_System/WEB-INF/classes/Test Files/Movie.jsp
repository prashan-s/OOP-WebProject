	...
	<c:if test="${showAddForm == true}">
		<form method="post" action="MovieServlet">
			...
			<br> <br> <label for="quality">Quality</label> <input
				...
				for="action_category">Action Category</label> <input type="checkbox"
				name="action_category"> <br> <br> <label
				for="adventure_category">Adventure Category</label> <input
			...
			<label for="scify_category">Science Fiction Category</label> <input
				type="checkbox" name="scify_category"> <br> <br> <label
				for="horror_category">Horror Category</label> <input type="checkbox"
				name="horror_category"> <br> <br> <label
				for="romance_category">Romance Category</label> <input
			...
			<label for="crime_category">Crime Category</label> <input
				type="checkbox" name="crime_category"> <br> <br> <label
				for="thriller_category">Thriller Category</label> <input
				type="checkbox" name="thriller_category"> <br> <br>
			<label for="created_admin_name">Created Admin Name</label> <input
				type="text" name="created_admin_name"> <br> <br> <br>
